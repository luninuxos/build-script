...
#Arelos iso build scrip based on Distroshare-Ubuntu-Imager by  https://www.distroshare.com
#
...
######                                    ######                             
######                                    ######                                         
###### Arelos iso build script $VERSION   ######
######                                    ######
######                                    ######
###### Special thanks to distroshare.com  ######
######                                    ######
######                                    ######
################################################
...
CONFIG_FILE="./arelos-iso-build-script.config"
...
cat > "${WORK}"/rootfs/arelos-iso-build-script.sh <<EOF
#!/bin/bash
...
grub-mkrescue -o "${WORK}"/arelos_dev_build.iso "${CD}"
